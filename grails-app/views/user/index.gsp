    ...
    <div class="col-md-5 panel-body">
        <div class="dropdown dropdown-menu-right">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                ...
                <li><g:link controller="user" action="recherche"
                            params="[kind: 'interested']">Envie de voir</g:link></li>
                <li><g:link controller="user" action="recherche"
                            params="[kind: 'favourite']">Coup de coeur</g:link></li>
            </ul>
        </div>
    </div>
...
<g:if test="${session["currentUser"].following}">
    <div class="panel">
        ...
        <g:each in="${session["currentUser"].following}" var="f">
            <div class="row"><g:link action="show"
                                     id="${f.id}"><div class="btn btn-lg text-primary"><span class="glyphicon glyphicon-user"></span> <strong>${f.username}</strong></g:link></div>
            </div>
        </g:each>
    </div>
    </div>
